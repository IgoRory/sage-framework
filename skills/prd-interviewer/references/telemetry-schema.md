...
**Emitter:** `python hooks/scripts/prd_telemetry_append.py '<json>'`.
...
Emitter: `skills/prd-orchestrator/SKILL.md`. All carry
...
Emitter: `skills/prd-interviewer/SKILL.md`. All carry
...
Emitter: `skills/prd-completeness-check/SKILL.md`. All carry
...
Emitter: `skills/prd-stale-check/SKILL.md`. All carry
...
Emitter: `skills/prd-amend/SKILL.md`. All carry
...
Emitter: `skills/prd-walkthrough/SKILL.md`. All carry
...
- `skills/prd-orchestrator/SKILL.md` (§1 events)
- `skills/prd-interviewer/SKILL.md` (§2 events)
- `skills/prd-completeness-check/SKILL.md` (§3 events)
- `skills/prd-stale-check/SKILL.md` (§4 — supporting-skill events)
- `skills/prd-amend/SKILL.md` (§4 — supporting-skill events)
- `skills/prd-walkthrough/SKILL.md` (§4 — supporting-skill events)
