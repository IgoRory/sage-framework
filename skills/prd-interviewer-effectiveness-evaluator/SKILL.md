...
| prd-interviewer SKILL.md | `skills/prd-interviewer/SKILL.md` | Yes |
| Per-section question-set files | `skills/prd-interviewer/references/question-sets/` (folder — Phase A split) | Yes |
| Telemetry schema | `skills/prd-interviewer/references/telemetry-schema.md` (single source of truth for every event) | Yes |
