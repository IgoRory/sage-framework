...
3. Do not touch skills/, agents/, AGENTS.md, or any
   framework file.
...
- Inherits the application-fidelity hard rule from
  `skills/prd-interviewer/references/sub-agent-delegation.md` §4.
...
| File | Purpose |
|---|---|
| `skills/prd-stale-check/SKILL.md` | Prerequisite — run before prd-amend in auto mode |
| `skills/prd-interviewer/references/handoff-prompt-templates.md` | Base templates for paste-ready handoff prompts |
| `skills/prd-interviewer/references/sub-agent-delegation.md` | Three-surface handoff discipline and application-fidelity rule |
