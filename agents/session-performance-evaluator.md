...
description: "Reads workflow-telemetry.jsonl and evaluates session performance across SAGE dimensions, opening Linear issues for violations. Use post-cycle (SAGE Hone) to assess a session."
---
