---
name: dev-interview
description: "Conducts the S1 developer interview — asks targeted technical questions and refines TDD spec scenarios with the developer. Use to scope and validate a phase before planning."
---
...
- If `skills/clean-arch-guide/SKILL.md` is available in the active product repo, read it before evaluating V2 layer placement.
