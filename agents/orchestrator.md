---
name: orchestrator
description: "Primary coordination agent for all SAGE workflow modes. Use at sprint kick-off, phase transitions, post-merge regression, and review & merge to manage the full feature lifecycle and generate the session manifest and TDD specs."
---
...
When generating `session-manifest.md`, populate it from the session manifest template at `templates/session-manifest-template.md`. Fill in:
