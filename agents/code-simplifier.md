...
description: "Applies clarity/maintainability simplifications directly to code after each S5 task, preserving behaviour. Use to clean up freshly written code during the build."
---
