...
description: "Produces S4 plan-preview artifacts (e.g. mockups) for PM confirmation before the build phase begins. Use to generate a reviewable preview of the planned change."
---
...
- `skills/validation-mockup-generator/styling-reference.md` — app design tokens, colour palette, component patterns
- `skills/validation-mockup-generator/mockup-templates.md` — HTML skeleton templates
