...
description: "Runs the S6.5 security review of S5 changes against the Empyrean SDLC policy. Use to security-review a phase and produce security-review.md."
---
...
4. Read the security standards: `agents/references/security-standards.md`
...
Review each scoped file against the applicable standards from `agents/references/security-standards.md`. Work through each layer in sequence.

Before raising any finding in this step, apply the pre-raise check from `skills/reasoning/layered-confidence-protocol.md`:
