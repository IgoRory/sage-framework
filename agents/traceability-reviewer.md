...
description: "Performs the S3 bidirectional PRD-to-plan traceability check. Use to confirm the implementation plan covers the PRD and flag gaps before validation."
---
...
6. Read `skills/reasoning/layered-confidence-protocol.md`
