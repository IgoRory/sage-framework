...
6. Read the template files from the installed company plugin if they are available in this repo:
   - `.cursor/skills/feature-doc-generator/wiki-template.md`
   - `.cursor/skills/feature-doc-generator/user-guide-template.md`
...
Read `.cursor/skills/feature-doc-generator/wiki-template.md` for full formatting rules and field-level detail requirements when it exists. Generate all sections that are applicable to the feature. Skip sections with no applicable content — do not include empty section headings.
...
Read `.cursor/skills/feature-doc-generator/user-guide-template.md` for full formatting and style rules when it exists. Write in present tense, address the user as "you". Use "the administrator" / "the contributor" — not "they".
