...
| `.cursor/skills/prd-stale-check/SKILL.md` | Run before walkthrough if PM suspects drift |
| `.cursor/skills/prd-amend/SKILL.md` | Run after walkthrough if PM decides to amend stale surfaces |
